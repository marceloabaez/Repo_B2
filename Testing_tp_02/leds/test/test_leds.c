...
// Con todos los leds apagados, prendo el led 2, verifico que se el bit 1
// vale 1. Con el led 2 prendido, apago el led 2, verifico que se enciende el
// bit 1 vale 0. Con todos los leds apagados, prendo el 3, prendo el 5, apago el
// 3 y apago el 7, deberían quedar el bit 4 en 1 y el resto en 0 Prendo un led,
// consulto el estado y tiene que estar prendido. Apago un led, consulto el
// estado y tiene que estar apagado. Con todos los leds apagados, prendo todos
// los leds y verifico que se encienden. Con todos los leds prendidor, apagado
// todos los leds y verifico que se apagan. Revisar los valores limites de los
// argumentos. Revisar que pasa con valores erroneos en los argumento. Poder
// utilizar lógica directa e inversa. Consultar el estado de un LED
...
// Con todos los leds apagados, prendo el 3, prendo el 5, apago el 3 y apago el
// 7, deberían quedar el bit 4 en 1 y el resto en 0
...
// Con todos los leds apagados, prendo todos los leds y verifico que se
// encienden.
...
// Con todos los leds encendidos, apagar todos los leds y verifico que se
// apagan.
...
void test_consulta_estado(void) {
  ...
  ledsTurnOnSingle(4);
  ledsTurnOnSingle(15);
  TEST_ASSERT_EQUAL(1, ledsIsTurnedOn(4));
  TEST_ASSERT_EQUAL(1, ledsIsTurnedOn(15));
}
...
void test_consulta_estado_LI(void) {
  ...
  ledsTurnOnSingle(4);
  ledsTurnOnSingle(15);
  TEST_ASSERT_EQUAL(0, ledsIsTurnedOn(4));
  TEST_ASSERT_EQUAL(0, ledsIsTurnedOn(15));
}